...
func (rp *NativeReverseProxy) serveWebsocket(
...
func (rp *NativeReverseProxy) doResponse(
	req *http.Request,
	reqData *RequestData,
	rsp *http.Response,
	isDebug bool,
	...
	if isDebug {
		...
		fastHeaderSet(
			rsp.Header,
			"X-Debug-Backend-Id",
			strconv.FormatUint(uint64(reqData.BackendIdx), 10),
		)
...
func (rp *NativeReverseProxy) roundTripWithData(
	req *http.Request,
	reqData *RequestData,
	err error,
) (rsp *http.Response) {
